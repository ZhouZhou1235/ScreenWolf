...
public class GameTray {
    ...
    public GameTray(Image iconImage,String tooltip,WindowBase window){
        ...
        trayIcon.addMouseListener(new MouseAdapter(){
            ...
            public void mouseClicked(MouseEvent e){
                if(e.getButton()==MouseEvent.BUTTON1){welcomeWindow.setVisible(true);}
            }
        });
        try{systemTray.add(trayIcon);}catch(AWTException e){throw new RuntimeException(e);}
        // 托盘选项
        addMenuItem("显示开始窗口",new ActionListener(){
            @Override
        ...
        addSeparator();
        addMenuItem("结束程序",new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent e){
                System.exit(0);
            }
